...
var { updateCommandeStatus: updateCommandeStatus2 } = (init_netlify_blobs(), __toCommonJS(netlify_blobs_exports));
...
exports.handler = async (event) => {
  ...
  try {
    ...
    const updated = await updateCommandeStatus2(id, status);
    return {
      statusCode: 200,
      headers,
