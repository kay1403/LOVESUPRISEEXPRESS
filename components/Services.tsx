...
import { X, Info, Sparkles, Clock, MapPin, CreditCard } from 'lucide-react'
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
            {services.map((service, index) => (
              <motion.div
                ...
                className="glass-card rounded-2xl overflow-hidden cursor-pointer group transition-all duration-300 hover:shadow-2xl"
              >
                <div className="h-48 overflow-hidden relative">
                  ...
                  <div className="absolute inset-0 bg-gradient-to-t from-black/50 to-transparent opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex items-end justify-start p-4">
                    <span className="text-white text-sm font-semibold bg-primary/80 px-3 py-1 rounded-full">Cliquez pour détails</span>
                  </div>
                </div>
                <div className="p-6">
          ...
          >
            ...
            >
              ...
              <div className="p-6 space-y-6">
                ...
                <div className="grid md:grid-cols-2 gap-4 p-4 bg-primaryLight rounded-xl">
                  <div className="flex items-center gap-3">
                    <Clock size={24} className="text-primary" />
                    <div>
                      <p className="text-sm text-gray-500">Durée de préparation</p>
                      <p className="font-semibold text-dark">{selectedService.duration}</p>
                    </div>
                  </div>
                  <div className="flex items-center gap-3">
                    <MapPin size={24} className="text-primary" />
                    <div>
                      <p className="text-sm text-gray-500">Zone de couverture</p>
                      <p className="font-semibold text-dark">{selectedService.coverage}</p>
                    </div>
                  </div>
                </div>
