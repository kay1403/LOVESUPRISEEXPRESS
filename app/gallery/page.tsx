...
import { ArrowLeft, X, Heart, User, Calendar } from 'lucide-react'

// Photos des clients heureux (preuve sociale)
const clientGallery = [
  {
    id: 1,
    ...
    <main className="min-h-screen bg-primaryLight">
      ...
      <section className="py-16">
        <div className="container-custom">
          ...
          >
            <div className="inline-flex items-center gap-2 bg-white/80 px-4 py-2 rounded-full mb-4 shadow-sm">
