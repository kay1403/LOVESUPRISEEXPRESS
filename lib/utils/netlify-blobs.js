...
// ⚠️ IMPORTANT: Utiliser le PROJECT ID (Site ID), pas le Blobs Store ID !
// Project ID: 2ad6edd4-3a49-4e3c-b68a-ee3ee992f448
const SITE_ID = '2ad6edd4-3a49-4e3c-b68a-ee3ee992f448';

export async function getStore(storeName) {
  // Mode développement (local)
  const isLocal = typeof localStorage !== 'undefined' && process.env.NODE_ENV === 'development';
  ...
  // Mode production (Netlify) - avec SITE_ID explicite
  console.log(`☁️ Production mode: ${storeName} (Netlify Blobs avec SITE_ID)`);
  
  try {
    // Utiliser le SITE_ID (Project ID) correct
